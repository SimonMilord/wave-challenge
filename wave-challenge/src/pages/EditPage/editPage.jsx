...
class EditPage extends Component {
  ...
  // calls the API get function when editpage mounts
  componentDidMount() {
    // normally I would hide the API key in ENV variables
    axios
      .get(
        `https://rawgit.com/wvchallenges/se-exp-challenge-invoice/master/settings.json`
      )
      .then((res) => {
        // set my response to the state given the id that matches the params
