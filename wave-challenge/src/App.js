...
export default function App() {
  ...
  const getCustomers = () => {
    // normally I would hide the API key in ENV variables but since it is not so sensitive I left it directly in the get request
    axios
      .get(
  ...
  return (
    // Routing for MainPage and edit page
    <Router>
      <div className="App">
        <Switch>
          <Route
            ...
            exact
            render={(routerProps) => (
              <MainPage {...routerProps} data={customersData} />
            )}
          />
          <Route
            path="/edit/:id"
